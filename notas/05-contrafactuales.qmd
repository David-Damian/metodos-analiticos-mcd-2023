...
En otro caso, es difícil establecer que significado tienen los contrafactuales.
...
llama al modelo $p(x, y^1, y^0)$ el modelo "científico", 
...
generalmente es necesario hacer supuestos considerables acerca de estos dos modelos.
...
del dolor inicial. Establecemos el modelo
...
qué la comparación simple de grupos no se deben a efectos causales.
...
$E[Y^0|T=1] - E[Y^0|T=0]$ fuera muy grande, lo cual haría nuestro estimador 
ingenuo $\delta_{ing}$ podría ser muy grande, aún cuando $E[Y^1|T=1] - E[Y^0|T=1]$ fuera cercano a cero
...
en la habilidad mental de personas adultas, y el tratamiento es ir a la universidad.
